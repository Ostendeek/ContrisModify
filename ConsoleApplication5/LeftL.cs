    ...
    class LeftL : FigureBase
    {
        ...
        public override bool CheckRight(Field field)
        {
            ...
            else
            {
                if (_position == 2)
                {
                    if (field.TetrisField[field.CurY, field.CurX + 2] == true || field.TetrisField[field.CurY + 1, field.CurX + 1] == true ||
                ...
                if (_position == 3)
                {
                    if (field.TetrisField[field.CurY + 1, field.CurX + 1] == true || field.TetrisField[field.CurY + 2, field.CurX + 3] == true ||
                        field.CurX == field.Width - 4) return false;
                    else return true;
                }
        ...
        public override bool CheckDown(Field field)
        {
            if (_position == 1)
            {
                if (field.TetrisField[field.CurY + 1, field.CurX] == true || field.TetrisField[field.CurY + 1, field.CurX + 1] == true ||
                    field.TetrisField[field.CurY + 2, field.CurX + 2] || (field.CurY + 2) == field.Height - 1) return false;
                else return true;
            }
            ...
            else
            {
                if (_position == 2)
                {
                    if (field.TetrisField[field.CurY + 3, field.CurX] == true || field.TetrisField[field.CurY + 1, field.CurX + 1] ||
                ...
                if (_position == 3)
                {
                    for (int i = 0; i < 3; i++)
                    {
                        if (field.TetrisField[field.CurY + 3, field.CurX + i] == true || (field.CurY + 3) == field.Height - 1) return false;
                    }
                    return true;
                }
                ...
                if (_position == 4)
                {
                    if (field.TetrisField[field.CurY + 3, field.CurX + 1] == true || field.TetrisField[field.CurY + 3, field.CurX + 2] == true ||
                        (field.CurY + 3) == field.Height - 1) return false;
                    else return true;
                }
            }
        ...
        {
            if (field.TetrisField[1, field.CurX] == true || field.TetrisField[1, field.CurX + 1] == true || field.TetrisField[2, field.CurX + 2]) return true;
